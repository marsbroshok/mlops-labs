...
4. The pipeline also generates a new schema from the statistics. This is done for tracking. The imported schema will be used for the downstream components like *ExampleValidator*. But we also want to capture the autogenerated schema for future analysis.
